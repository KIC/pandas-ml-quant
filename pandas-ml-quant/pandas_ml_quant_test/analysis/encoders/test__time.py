...
from pandas_ml_quant.technichal_analysis import ta_decimal_year, ta_sinusoidal_week_day
from pandas_ml_quant_test.config import DF_TEST, DF_TEST_MULTI_ROW
import pandas as pd
