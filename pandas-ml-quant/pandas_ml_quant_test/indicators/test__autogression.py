...
from pandas_ml_quant.indicators.auto_regression import shape_for_auto_regression
...
class TestRegressionLagging(TestCase):
    ...
    def test_auto_regression_simple(self):
        df = DF_TEST.copy()
        rnn, min_needed_data = shape_for_auto_regression(df[["Close", "Volume"]], [1, 2])
    ...
    def test_lag_smoothing_nan(self):
        ...
        rnn, min_needed_data = shape_for_auto_regression(df[["featureA"]],
                                                         feature_lags=[0, 1],
